/**
 * @file Утилиты сортировки заказов
 * @module lib/sort-utils
 *
 * Предоставляет функции для сортировки заказов по различным полям:
 * статус (жизненный цикл), булевы поля, сумма, строковые поля.
 * Выделено из public/app.js для возможности тестирования.
 */

// Жизненный цикл статусов заказов (в порядке следования)
// Синхронизировано с public/app.js
