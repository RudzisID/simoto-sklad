...
// ═══════════════════════════════════════════════════════════════════════════════
// @cleanup 2026-05-23 — канал продаж w/o больше не пишется (отключено 2026-05-14)
//
...
// 11. тесты (если появятся) — удалить все references на getChannelAttrValue / ORDER_CHANNEL / DEMAND_CHANNEL
// ═══════════════════════════════════════════════════════════════════════════════
...
// @cleanup 2026-05-23 — функция отключена, всегда возвращает undefined
function getChannelAttrValue(orderFull) {
  // ────────────────────────────────────────────────────────────
  // Закомментировано 2026-05-14 — канал продаж w/o больше не пишем. Если появятся тесты на эту функцию — удалить их.
